...
const CustomButton = ({ button_icon, button_title, button_color, button_hovercolor, button_fun }: custom_button_props) => {
    return (
        <button
            ...
            className="flex items-center space-x-2 bg-[#2F80ED] text-white px-4 py-2 rounded-lg hover:bg-[#1366d6] transition-colors hover:shadow-lg hover:cursor-pointer text-sm-standard"
            onMouseEnter={(e) => {
